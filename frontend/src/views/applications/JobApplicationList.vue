...
import { useJobApplicationsStore } from '@/stores';
...
const { job_applications } = storeToRefs(jobApplicationsStore);
...
async function handleSearch(value: string) {
    await jobApplicationsStore.find(value)
}
        ...
        <div class="flex flex-col md:flex-row items-start gap-4">
            ...
            <main class="p-2 w-full md:w-3/4">
                ...
                <div class="flex flex-col gap-4">
                    <JobApplicationCard v-for="job in job_applications" :key="job.id" :job="job" class="hover-up" />

                    <div class="col-span-1 md:col-span-2 lg:col-span-3 text-gray-500">
                        <p v-if="job_applications.length === 0" class="text-center">
                            No se encontraron ofertas de trabajo.
                        </p>
                        <n-pagination v-if="job_applications.length !== 0" v-model:page="page" :page-size="pageSize"
